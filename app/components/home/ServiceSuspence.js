...
const ServiceSuspence = () => {
  ...
  return (
    <div className="mx-auto py-20 sm:py-40 px-5 sm:px-10 overflow-hidden" style={bannerColor}>
      <div className="flex flex-col sm:flex-row justify-between items-center">
        ...
        <div className="w-full sm:w-auto sm:ml-10 lg:ml-20 rounded-lg">
          <video
            width="100%"
            className="rounded-xl scale-100 sm:scale-110 lg:scale-100 translate-x-0 sm:translate-x-10 lg:translate-x-0"
            autoPlay
            muted
            preload="auto"
          >
