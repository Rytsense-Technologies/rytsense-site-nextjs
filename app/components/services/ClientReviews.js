          ...
          <div class="flex flex-col items-center">
            <div class="text-center">
              <p class="text-lg font-medium text-gray-600 font-pj">
                50+ people have said how good Rytsense Technologies
              </p>
            ...
            <div class="relative mt-10 md:mt-24 md:order-2">
              <div className="absolute inset-x-[-1px] inset-y-16 md:inset-x-[-2px] md:inset-y-6">
                <div
                ...
                <div class="flex flex-col overflow-hidden shadow-xl">
                  <div class="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div class="flex-1">
                      ...
                      <blockquote class="flex-1 mt-8">
                        <p class="text-lg leading-relaxed text-gray-900 font-pj">
                          “I can confidently recommend Rytsense Technologies as
                          a dedicated and reliable supplier,and experts in their
                          field.”
                        </p>
                      </blockquote>
                    </div>
