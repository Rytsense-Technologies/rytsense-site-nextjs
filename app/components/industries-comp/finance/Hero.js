      ...
      <div className="mx-auto px-4 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-2/5 space-y-8">
          <div className="w-10 h-10  flex items-center justify-center rounded-lg shadow-lg">
            <BsBank2 className="text-sky-600"/>
          </div>
        ...
        <div className="md:w-3/5 relative mt-8 md:mt-0">
          <div className="relative">
            ...
            />
            {/* Floating Elements */}
            <div className="absolute top-0 left-0 transform  w-44 bg-white rounded-lg shadow-lg p-4">
              <p className="text-gray-700 text-sm">Card 1 . . . 0632</p>
              <p className="text-gray-500 text-xs">Exp 12/26</p>
              <p className="text-lg font-bold text-gray-900">$460,249</p>
              <p className="text-green-500 text-xs">+12.32% vs Last Week</p>
            </div>

            <div className="absolute bottom-0 right-0 transform  w-36 bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="absolute bottom-0 left-0 transform   w-32 bg-white rounded-lg shadow-lg p-4">
              <p className="text-gray-700 text-xs">Expenses</p>
              <p className="text-lg font-bold text-gray-900">$9,137</p>
              <p className="text-red-500 text-xs">35%</p>
            </div>

            <div className="absolute top-0 right-0 transform  w-44 bg-white rounded-lg shadow-lg p-4">
              <p className="text-gray-700 text-sm">$120.00</p>
              <p className="text-xs text-gray-500">Free fee transfer 🎉</p>
