...
const page = () => {
  return (
    <>
      <HeroSection
        title={"Cryptocurrency Exchange DevelopmentCompany"}
        subTitle={
      ...
      <div>
        <div className=" min-h-screen">
          <div className="container mx-auto py-8 px-4">
            ...
            <section>
              <p className="text-gray-700">
                Rytsense Technologies is an eminent Blockchain company that
          ...
          >
            <h1 className="font-bold text-xl text-gray-800 mb-5">
              Why Choose Rytsense Technologies for Cryptocurrency Exchange
              Development?
            </h1>
            <h1 className="font-bold text-xl text-gray-800">
              {" "}
